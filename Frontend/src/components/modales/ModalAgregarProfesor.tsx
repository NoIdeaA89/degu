...
export const AgregarProfesor = () => {
  ...
  const handleAgregarProfesor = async (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    setErrorMensaje(null);
    ...
    try {
      ...
      setExitoMensaje('Profesor agregado exitosamente.');
      resetForm();

      // Cierra el modal después de un breve instante para que se vea el mensaje de éxito
      setTimeout(() => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
            ...
            <div className="flex items-center gap-3 mb-4 text-red-600">
              ...
              <h3 className="text-xl font-bold">Agregar Nuevo Profesor</h3>
            </div>
            ...
            <form onSubmit={handleAgregarProfesor} className="space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                  {isLoading ? 'Guardando...' : 'Agregar profesor'}
                </button>
              </div>
            </form>
          </div>
